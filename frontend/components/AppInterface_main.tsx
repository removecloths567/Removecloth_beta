...
export const AppInterface: React.FC<AppInterfaceProps> = ({ user, onUpdateCredits, onNavigatePricing }) => {
    ...
    return (
        <div className="min-h-screen pt-24 pb-12 px-4 bg-black flex items-center justify-center relative transition-colors duration-500 overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden">
                 <div className={`absolute top-1/4 left-1/4 w-[800px] h-[800px] blur-[200px] rounded-full opacity-30 animate-pulse-slow ${errorType === 'credits' ? 'bg-amber-600' : 'bg-primary'}`}></div>
                 <div className={`absolute bottom-1/4 right-1/4 w-[800px] h-[800px] blur-[200px] rounded-full opacity-15 animate-pulse-slow ${errorType === 'credits' ? 'bg-orange-600' : 'bg-secondary'}`} style={{animationDelay: '2s'}}></div>
                ...
                {status === GenerationStatus.ERROR ? (
                    <div className="text-center animate-[fadeIn_0.6s_ease-out]">
                        ...
                        <div className="relative mb-16 inline-block">
                             {/* Central Core Bloom */}
                             <div className={`absolute inset-0 blur-[100px] rounded-full scale-150 animate-pulse opacity-60 ${errorType === 'credits' ? 'bg-amber-500' : 'bg-red-500'}`}></div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
                            {errorType === 'credits' ? (
                                <button 
                                    ...
                                    className="w-full sm:w-auto px-20 py-7 bg-amber-500 hover:bg-amber-400 rounded-3xl font-black text-black hover:shadow-[0_0_60px_rgba(245,158,11,0.7)] transition-all shadow-3xl uppercase tracking-[0.3em] active:scale-95 flex items-center justify-center gap-5 group text-xl"
                                >
                                ...
                                <button 
                                    ...
                                    className="w-full sm:w-auto px-20 py-7 gradient-bg rounded-3xl font-black text-white hover:shadow-[0_0_60px_rgba(255,0,82,0.7)] transition-all shadow-3xl uppercase tracking-[0.3em] active:scale-95 flex items-center justify-center gap-5 group text-xl"
                                >
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4 bg-gray-50 dark:bg-black transition-colors duration-300">
        ...
        {currentStep === 'upload' ? (
            <div className="bg-white/90 dark:bg-[#101010]/90 backdrop-blur-3xl border border-gray-200 dark:border-white/10 rounded-[3rem] p-8 md:p-16 shadow-[0_40px_100px_rgba(0,0,0,0.5)] relative overflow-hidden animate-[fadeIn_0.6s_ease-out]">
                 <div className="text-center mb-16">
                    <h2 className="text-5xl md:text-6xl font-black text-gray-900 dark:text-white mb-4 tracking-tighter uppercase">Target Data</h2>
                 ...
                 <div className="max-w-2xl mx-auto">
                    {!previewUrl ? (
                         <div 
                            className="h-[480px] border-2 border-dashed border-gray-300 dark:border-white/10 hover:border-primary/50 hover:bg-gray-50 dark:hover:bg-primary/[0.03] rounded-[2.5rem] flex flex-col items-center justify-center transition-all duration-700 cursor-pointer group relative overflow-hidden"
                    ...
                    <div className="mt-16 flex justify-center">
                         <button
                            ...
                            className={`
                                w-full md:w-auto px-20 py-6 rounded-[2rem] font-black text-2xl flex items-center justify-center gap-4 transition-all duration-700 relative overflow-hidden group active:scale-95
                                ${!selectedFile
            ...
            <div className="space-y-12">
                            ...
                            <div className="flex gap-8">
                                {['female', 'male'].map((g) => (
                                    <button
                                        ...
                                        className={`
                                            flex-1 py-12 px-8 rounded-[2.5rem] font-black text-2xl capitalize transition-all border-2 flex flex-col items-center justify-center gap-5 group
                                            ${config.gender === g 
                                        ...
                                        `}
                                    >
                                        <div className={`p-6 rounded-[1.5rem] transition-all duration-500 ${config.gender === g ? 'bg-primary text-white scale-110 rotate-6 shadow-xl shadow-primary/30' : 'bg-gray-100 dark:bg-white/5 group-hover:scale-110 group-hover:rotate-6'}`}>
                                            {g === 'female' ? <Venus size={48} /> : <Mars size={48} />}
                                        </div>
                                        <span className="uppercase tracking-widest text-lg">{g}</span>
                                    </button>
                                ))}
                            </div>
                        </Section>
                ...
                <div className="sticky bottom-8 z-30 bg-white/95 dark:bg-[#080808]/95 backdrop-blur-3xl border border-gray-200 dark:border-white/10 p-6 rounded-[2.5rem] flex flex-col sm:flex-row justify-between items-center shadow-[0_30px_90px_rgba(0,0,0,0.6)] mt-20 gap-8 animate-[slideInUp_0.8s_ease-out]">
                     ...
                     <button 
                        ...
                        className={`
                             w-full sm:w-auto px-16 py-5 rounded-2xl font-black text-2xl flex items-center justify-center gap-4 transition-all duration-700 active:scale-95
                             ${!isConfigComplete()
...
const ImageCard: React.FC<{label: string; image: string; selected: boolean; onClick: () => void; compact?: boolean}> = ({ label, image, selected, onClick, compact }) => (
    <div 
        onClick={onClick}
        className={`
            relative aspect-[3/4] rounded-3xl overflow-hidden cursor-pointer group transition-all duration-700
